...
Describes how to validate the field. This object is supposed to be passed in `addField` method. All possible rules listed [here](rules).

The object contains several properties/methods:

#### rule

A rule string (listed [here](rules)).
